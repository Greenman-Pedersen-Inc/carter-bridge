require([
    ...
    'esri/PopupTemplate',
], (Map, MapView, FeatureLayer, LayerList, esriRequest, GroupLayer, PopupTemplate, MapImageLayer, GraphicsLayer) => {
    const template = {
        title: '{name}',
        content: '{comments}',
    };
    ...
    function queryFeatureLayer(extent) {
        const parcelQuery = {
            ...
            outFields: ['phase', 'comments', 'name'], // Attributes to return
            returnGeometry: true,
        };
    ...
    function displayResults(results) {
        ...
        const popupTemplate = {
            title: '{name}',
            content: 'Type: {UseType} <br> Land value: {Roll_LandValue} <br> Tax Rate City: {comments}',
        };
...
if ('URLSearchParams' in window) {
    // Feature detection (URLSearchParams is not supported by Internet Explorer)
